...
# summary(m6) # Model didn't converge -> remove random slopes (lenght and macron) by workerId
...
# anova(m12, m13) # not significant, choose m12 (do not remove length) 
...
```{r model2 (Exp2), echo=T, message=F, warning=F, eval=T}
# Model fitting: fixed-effects & mixed-effects
# m1 <- glm(correct ~ (c.(score) + c.(n.neighbors) + c.(familiarity) + macron)^2 + c.(length), data=dataExp2, family=binomial(link="logit"))
# summary(m1) # remove familiarity:macron
# m2 <- update(m1, . ~ . -c.(familiarity):macron)
# anova(m1, m2, test="Chisq") # not significant, choose m2 (remove familiarity:macron)
# summary(m2) # remove score:n.neighbors
# m3 <- update(m2, . ~ . -c.(score):c.(n.neighbors))
# anova(m2, m3, test="Chisq") # not significant, choose m3 (remove score:n.neighbors)
# summary(m3) # remove score:familiarity
# m4 <- update(m3, . ~ . -c.(score):c.(familiarity))
# anova(m3, m4, test="Chisq") # not significant, choose m4 (remove score:familiarity)
# m5 <- glmer(correct ~ c.(n.neighbors)*c.(familiarity) + c.(n.neighbors)*macron + c.(score)*macron + c.(length) + (1 + c.(score) + c.(length) + c.(n.neighbors) + c.(familiarity) + macron|workerId) + (1|word), family = binomial(link = "logit"), data = dataExp2, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e6)))
# summary(m5) # remove n.neighbors:familiarity
# m6 <- glmer(correct ~ c.(familiarity) + c.(n.neighbors)*macron + c.(score)*macron + c.(length) + (1 + c.(score) + c.(length) + c.(n.neighbors) + c.(familiarity) + macron|workerId) + (1|word), family = binomial(link = "logit"), data = dataExp2, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e6)))
# anova(m5, m6) # not significant, choose m6 (remove n.neighbors:familiarity)
# summary(m6) # singular fit, remove random slopes (n.neighbors, length and macron) by workerId
# m7 <- glmer(correct ~ c.(familiarity) + c.(n.neighbors)*macron + c.(score)*macron + c.(length) + (1 + c.(score) + c.(familiarity)|workerId) + (1|word), family = binomial(link = "logit"), data = dataExp2, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e6)))
# summary(m7) # remove macron:score
# m8 <- glmer(correct ~ c.(familiarity) + c.(n.neighbors)*macron + c.(score) + c.(length) + (1 + c.(score) + c.(familiarity)|workerId) + (1|word), family = binomial(link = "logit"), data = dataExp2, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e6)))
# anova(m7, m8) # not significant, choose m8 (remove macron:score)
# summary(m8) # remove score
# m9 <- glmer(correct ~ c.(familiarity) + c.(n.neighbors)*macron + c.(length) + (1 + c.(familiarity)|workerId) + (1|word), family = binomial(link = "logit"), data = dataExp2, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e6)))
# anova(m8, m9) # not significant, choose m9 (remove score)
# summary(m9) # add a random slope (macron) by workerId
# m10 <- glmer(correct ~ c.(familiarity) + c.(n.neighbors)*macron + c.(length) + (1 + c.(familiarity) + macron|workerId) + (1|word), family = binomial(link = "logit"), data = dataExp2, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e6)))
# summary(m10) # remove n.neighbors:macron
# m11 <- glmer(correct ~ c.(familiarity) + c.(n.neighbors) + macron + c.(length) + (1 + c.(familiarity) + macron|workerId) + (1|word), family = binomial(link = "logit"), data = dataExp2, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e6)))
# anova(m10, m11) # not significant, choose m11 (remove n.neighbors:macron)
# summary(m11) # remove n.neighbors
# m12 <- glmer(correct ~ c.(familiarity) + macron + c.(length) + (1 + c.(familiarity) + macron|workerId) + (1|word), family = binomial(link = "logit"), data = dataExp2, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e6)))
# anova(m11, m12) # not significant, choose m12 (remove n.neighbors)
# summary(m12) # remove length 
# m13 <- glmer(correct ~ c.(familiarity) + macron + (1 + c.(familiarity) + macron|workerId) + (1|word), family = binomial(link = "logit"), data = dataExp2, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e6)))
# anova(m12, m13) # not significant, choose m13 (remove length)
# saveRDS(m13, file = "exp2.rds")
mExp2 <- readRDS("./exp2.rds")
logistic_table(mExp2, caption="Model summary of accuracy without participants' individual differences. All numeric variables in this model are centered.")
```

### Effect plots from the model without participants' individual differences

```{r model2 (Exp2) effect, echo=F, message=F, warning=F, eval=T, fig.width=7, fig.height=2.5, fig.cap="Effect plots of: familiarity (Fig.a); and the presence of macrons (Fig.b)."}
# 1) Familiarity
exp2_1 <- as.data.frame(effect(term="c.(familiarity)", mod=mExp2))
exp2_1$type <- "Word"
F_Exp2_1 <- ggplot(exp2_1, aes(x=familiarity, y=fit, color = type, fill=type)) + geom_line(size=1) + geom_ribbon(aes(ymin=fit-se, ymax=fit+se),alpha=0.2, color=NA) + labs(x= "Familiarity", y="Accuracy") + scale_color_manual(values = c("Word" = "blue")) + scale_fill_manual(values = c("Word" = "blue")) + theme_bw() + theme(legend.position="none", legend.title=element_blank(), panel.background = element_blank(), axis.text=element_text(size=10), axis.title=element_text(size = 10, face = "bold"),legend.text=element_text(size=10), strip.text = element_text(size = 10, face="bold"))

# 2) Macron
exp2_2 <- as.data.frame(effect(term="macron", mod=mExp2))
exp2_2$Macron <- "Macron = FALSE"
exp2_2[exp2_2$macron=="TRUE",]$Macron <- "Macron = TRUE"
exp2_2$type <- "Word"
F_Exp2_2 <- ggplot(exp2_2, aes(x=macron, y=fit, color=type, fill=type)) + geom_point(size=4, position=position_dodge(width=0.2)) + geom_line(aes(x=as.integer(macron)), size=1, alpha=0.4, position=position_dodge(width=0.2)) + geom_errorbar(aes(ymin=fit-se, ymax=fit+se), size=1, width=0.3, position=position_dodge(width=0.2)) + xlab("Presence of macron") + ylab("Accuracy") + ylim(c(0, 1)) + scale_color_manual(values = c("Word" = "blue")) + scale_fill_manual(values = c("Word" = "blue")) + theme_bw() + theme(plot.title = element_text(hjust = 0.5, size=15), legend.position="none", legend.title=element_blank(), panel.background = element_blank(), axis.text=element_text(size=13), axis.title=element_text(size = 13, face = "bold"),legend.text=element_text(size=12), strip.text = element_text(size = 13, face="bold")) 

ggarrange(F_Exp2_1, F_Exp2_2, labels=c("a.","b."), ncol=2)
```
...
```{r māorilist (Exp2), echo=T, message=F, warning=F, eval=T}
# Model fitting: fixed-effects & mixed-effects
...
```{r māorilist (Exp2) effect, echo=F, message=F, warning=F, eval=T, fig.width=14, fig.height=3.5, fig.cap="Effect plots of: the interaction between familiarity and participants’ basic knowledge of Māori (Fig.a); and the presence of macrons (Fig.b)."}
# 1) Familiarity*Basic knowledge
exp2ML_1 <- as.data.frame(effect(term="c.(familiarity):c.(maoriList)", mod=mExp2MaoriList))
exp2ML_1$maoriList1 <- "Basic knowledge = 0"
exp2ML_1[exp2ML_1$maoriList=="0",]$maoriList1 <- "Basic knowledge = 0"
exp2ML_1[exp2ML_1$maoriList=="2",]$maoriList1 <- "Basic knowledge = 2"
exp2ML_1[exp2ML_1$maoriList=="4",]$maoriList1 <- "Basic knowledge = 4"
exp2ML_1[exp2ML_1$maoriList=="7",]$maoriList1 <- "Basic knowledge = 7"
exp2ML_1[exp2ML_1$maoriList=="9",]$maoriList1 <- "Basic knowledge = 9"
exp2ML_1$type <- "Word"
F_Exp2ML_1 <- ggplot(exp2ML_1, aes(x=familiarity, y=fit, color = type, fill=type)) + geom_line(size=1) + facet_grid(. ~ maoriList1) + geom_ribbon(aes(ymin=fit-se, ymax=fit+se),alpha=0.2, color=NA) + labs(x= "Familiarity", y="Accuracy") + scale_color_manual(values = c("Word" = "blue")) + scale_fill_manual(values = c("Word" = "blue")) + theme_bw() + theme(legend.position="none", legend.title=element_blank(), panel.background = element_blank(), axis.text=element_text(size=10), axis.title=element_text(size = 12, face = "bold"),legend.text=element_text(size=10), strip.text = element_text(size = 12, face="bold")) 

# 2) Macron
exp2ML_2 <- as.data.frame(effect(term="macron", mod=mExp2MaoriList))
exp2ML_2$Macron <- "Macron = FALSE"
exp2ML_2[exp2ML_2$macron=="TRUE",]$Macron <- "Macron = TRUE"
exp2ML_2$type <- "Word"
F_Exp2ML_2 <- ggplot(exp2ML_2, aes(x=macron, y=fit, color=type, fill=type)) + geom_point(size=4, position=position_dodge(width=0.2)) + geom_line(aes(x=as.integer(macron)), size=1, alpha=0.4, position=position_dodge(width=0.2)) + geom_errorbar(aes(ymin=fit-se, ymax=fit+se), size=1, width=0.3, position=position_dodge(width=0.2)) + xlab("Presence of macron") + ylab("Accuracy") + ylim(c(0, 1)) + scale_color_manual(values = c("Word" = "blue")) + scale_fill_manual(values = c("Word" = "blue")) + theme_bw() + theme(plot.title = element_text(hjust = 0.5, size=15), legend.position="none", legend.title=element_blank(), panel.background = element_blank(), axis.text=element_text(size=13), axis.title=element_text(size = 13, face = "bold"),legend.text=element_text(size=12), strip.text = element_text(size = 13, face="bold")) 

ggarrange(F_Exp2ML_1, F_Exp2ML_2, labels=c("a.","b."), ncol=2, widths=c(5,1))
```
...
```{r māoriProf (Exp2), echo=T, message=F, warning=F, eval=T}
# Model fitting: fixed-effects and mixed-effects
...
```{r māoriProf (Exp2) effect, echo=F, message=F, warning=F, eval=T, fig.width=14, fig.height=3.5, fig.cap="Effect plots of: the interaction between familiarity and self-rated Māori proficiency (Fig.a); and the presence of macrons (Fig.b)."}
# 1) Familiarity*Proficiency
exp2MP_1 <- as.data.frame(effect(term="c.(familiarity):c.(maoriProf)", mod=mExp2MaoriProf))
exp2MP_1$maoriProf1 <- "Proficiency = 0"
exp2MP_1[exp2MP_1$maoriProf=="0",]$maoriProf1 <- "Proficiency = 0"
exp2MP_1[exp2MP_1$maoriProf=="1",]$maoriProf1 <- "Proficiency = 1"
exp2MP_1[exp2MP_1$maoriProf=="2",]$maoriProf1 <- "Proficiency = 2"
exp2MP_1[exp2MP_1$maoriProf=="3",]$maoriProf1 <- "Proficiency = 3"
exp2MP_1[exp2MP_1$maoriProf=="4",]$maoriProf1 <- "Proficiency = 4"
exp2MP_1$type <- "Word"
F_Exp2MP_1 <- ggplot(exp2MP_1, aes(x=familiarity, y=fit, color = type, fill=type)) + geom_line(size=1) + facet_grid(. ~ maoriProf1) + geom_ribbon(aes(ymin=fit-se, ymax=fit+se),alpha=0.2, color=NA) + labs(x= "Familiarity", y="Accuracy") + scale_color_manual(values = c("Word" = "blue")) + scale_fill_manual(values = c("Word" = "blue")) + theme_bw() + theme(legend.position="none", legend.title=element_blank(), panel.background = element_blank(), axis.text=element_text(size=10), axis.title=element_text(size = 12, face = "bold"),legend.text=element_text(size=10), strip.text = element_text(size = 12, face="bold"))

# 2) Macron
exp2MP_2 <- as.data.frame(effect(term="macron", mod=mExp2MaoriProf))
exp2MP_2$Macron <- "Macron = FALSE"
exp2MP_2[exp2MP_2$macron=="TRUE",]$Macron <- "Macron = TRUE"
exp2MP_2$type <- "Word"
F_Exp2MP_2 <- ggplot(exp2MP_2, aes(x=macron, y=fit, color=type, fill=type)) + geom_point(size=4, position=position_dodge(width=0.2)) + geom_line(aes(x=as.integer(macron)), size=1, alpha=0.4, position=position_dodge(width=0.2)) + geom_errorbar(aes(ymin=fit-se, ymax=fit+se), size=1, width=0.3, position=position_dodge(width=0.2)) + xlab("Presence of macron") + ylab("Accuracy") + ylim(c(0, 1)) + scale_color_manual(values = c("Word" = "blue")) + scale_fill_manual(values = c("Word" = "blue")) + theme_bw() + theme(plot.title = element_text(hjust = 0.5, size=15), legend.position="none", legend.title=element_blank(), panel.background = element_blank(), axis.text=element_text(size=13), axis.title=element_text(size = 13, face = "bold"),legend.text=element_text(size=12), strip.text = element_text(size = 13, face="bold"))

ggarrange(F_Exp2MP_1, F_Exp2MP_2, labels=c("a.","b."), ncol=2, widths=c(5,1))
```
...
```{r māoriExpo (Exp2), echo=T, message=F, warning=F, eval=T}
# Model fitting: fixed-effects and mixed-effects
...
```{r māoriExpo (Exp2) effect, echo=F, message=F, warning=F, eval=T, fig.width=6, fig.height=2, fig.cap="Effect plots of: the interaction between neighbourhood density and participants' exposure to Māori (Fig.a); the presence of macrons (Fig.b); and familiarity (Fig.c)."}
# 1) Neighbourhood density*Exposure
exp2ME_1 <- as.data.frame(effect(term="c.(n.neighbors):c.(maoriExpo)", mod=mExp2MaoriExpo))
exp2ME_1$maoriExpo1 <- "Exposure = 2"
exp2ME_1[exp2ME_1$maoriExpo=="2",]$maoriExpo1 <- "Exposure = 2"
exp2ME_1[exp2ME_1$maoriExpo=="4",]$maoriExpo1 <- "Exposure = 4"
exp2ME_1[exp2ME_1$maoriExpo=="6",]$maoriExpo1 <- "Exposure = 6"
exp2ME_1[exp2ME_1$maoriExpo=="8",]$maoriExpo1 <- "Exposure = 8"
exp2ME_1[exp2ME_1$maoriExpo=="10",]$maoriExpo1 <- "Exposure = 10"
exp2ME_1$type <- "Word"
exp2ME_1$maoriExpo1 <- factor(exp2ME_1$maoriExpo1, levels=c("Exposure = 2","Exposure = 4","Exposure = 6","Exposure = 8","Exposure = 10"))
F_Exp2ME_1 <- ggplot(exp2ME_1, aes(x=n.neighbors, y=fit, color = type, fill=type)) + geom_line(size=1) + facet_grid(. ~ maoriExpo1) + geom_ribbon(aes(ymin=fit-se, ymax=fit+se),alpha=0.2, color=NA) + labs(x= "Neighbourhood density", y="Accuracy") + scale_color_manual(values = c("Word" = "blue")) + scale_fill_manual(values = c("Word" = "blue")) + theme_bw() + theme(legend.position="none", legend.title=element_blank(), panel.background = element_blank(), axis.text=element_text(size=9), axis.title=element_text(size = 9, face = "bold"),legend.text=element_text(size=9), strip.text = element_text(size = 9, face="bold"))

# 2) Macron
exp2ME_2 <- as.data.frame(effect(term="macron", mod=mExp2MaoriExpo))
exp2ME_2$Macron <- "Macron = FALSE"
exp2ME_2[exp2ME_2$macron=="TRUE",]$Macron <- "Macron = TRUE"
exp2ME_2$type <- "Word"
F_Exp2ME_2 <- ggplot(exp2ME_2, aes(x=macron, y=fit, color=type, fill=type)) + geom_point(size=4, position=position_dodge(width=0.2)) + geom_line(aes(x=as.integer(macron)), size=1, alpha=0.4, position=position_dodge(width=0.2)) + geom_errorbar(aes(ymin=fit-se, ymax=fit+se), size=1, width=0.3, position=position_dodge(width=0.2)) + xlab("Presence of macron") + ylab("Accuracy") + ylim(c(0, 1)) + scale_color_manual(values = c("Word" = "blue")) + scale_fill_manual(values = c("Word" = "blue")) + theme_bw() + theme(plot.title = element_text(hjust = 0.5, size=9), legend.position="none", legend.title=element_blank(), panel.background = element_blank(), axis.text=element_text(size=9), axis.title=element_text(size = 9, face = "bold"),legend.text=element_text(size=9), strip.text = element_text(size = 9, face="bold"))

# 3) Familiarity
exp2ME_3 <- as.data.frame(effect(term="c.(familiarity)", mod=mExp2MaoriExpo))
exp2ME_3$type <- "Word"
F_Exp2ME_3 <- ggplot(exp2ME_3, aes(x=familiarity, y=fit, color = type, fill=type)) + geom_line(size=1) + geom_ribbon(aes(ymin=fit-se, ymax=fit+se),alpha=0.2, color=NA) + labs(x= "Familiarity", y="Accuracy") + scale_color_manual(values = c("Word" = "blue")) + scale_fill_manual(values = c("Word" = "blue")) + theme_bw() + theme(legend.position="none", legend.title=element_blank(), panel.background = element_blank(), axis.text=element_text(size=10), axis.title=element_text(size = 10, face = "bold"),legend.text=element_text(size=10), strip.text = element_text(size = 10, face="bold"))

ggarrange(F_Exp2ME_1, labels=c("a."))
ggarrange(F_Exp2ME_2, F_Exp2ME_3, labels=c("b.","c."), ncol=2, widths=c(1,1))
```
...
```{r Figure 5, echo=F, message=F, warning=F, eval=T, fig.width=13, fig.height=14, fig.cap="Figure 5: Effect plots of: the interaction between the neighbourhood density, the distinction between non vs. real word stimuli, and participant d' (Fig.a); the interaction between the stimulus length and participant d' (Fig.b); the interaction between the presence of macrons and participant d' (Fig.c); and the phonotactic score (Fig.d). For plots involving interactions with paricipant d', the upper panel represents participants with high d', and the lower panel represents participants with low d'. Plots on the left show predicted mean ratings and plots on the right show predicted distributions over ratings."}
dprimes = dataExp1DprimeFinite %>% group_by(workerId, dprime) %>% summarise() %>% pull(dprime)
dprime_cuts = c(3, 1)
yrange = c(2.3, 5)
...
```{r Figure 6, echo=F, message=F, warning=F, eval=T, fig.width=9, fig.height=5, fig.cap="Figure 6: Rate of accurate definitions per word. Words are displayed according to their phonotactic score on the x-axis and their accuracy rates are represented on the y-axis. Right panel contains words without a macron and left panel displays words with a macron (or macrons). Overlapping labels are not shown."}
Fig6 <- dataExp2[,c("workerId","word","correct","familiarity","score","macron")]
Fig6$correct1 <- 0;Fig6[Fig6$correct=="TRUE",]$correct1 <- 1;Fig6$correct1 <- as.numeric(Fig6$correct1)
accRate <- aggregate(Fig6$correct1, by=list(Fig6$word),  FUN=sum)
colnames(accRate) <- c("word","nbCorrect")
...
accRate$macron1 <- "Macron = TRUE"
accRate[accRate$macron=="FALSE",]$macron1 <- "Macron = FALSE"
ggplot(accRate, aes(x=score, y=rate, label=word)) + labs(x= "Phonotactic score", y="Accuracy rate") + geom_point(color="blue", size=3, alpha=0.2, shape=17) + theme(legend.title=element_blank()) + geom_text(color="blue", hjust=0.2,vjust=-0.7,check_overlap = TRUE, size=4) + theme_bw() + theme(legend.position="none", legend.title=element_blank(),panel.background = element_blank(), axis.text=element_text(size=13), axis.title=element_text(size = 13, face = "bold"),strip.text = element_text(size = 13, face="bold")) + xlim(c(-1.05, -0.55)) + facet_wrap(vars(macron1))
# nrow(unique(wordScoreMacron[wordScoreMacron$macron=="TRUE",])) # 23 words containing a macron (or macrons)
# nrow(unique(wordScoreMacron[wordScoreMacron$macron=="FALSE",])) # 95 words without a macron
```

## Figure 7

```{r Figure 7, echo=F, message=F, warning=F, eval=T, fig.width=14, fig.height=3.5, fig.cap="Figure 7: Effect plots of: the interaction between familiarity and participants’ basic knowledge of Māori (Fig.a); and the presence of macrons (Fig.b)."}
# 1) Familiarity*Basic knowledge
# exp2ML_1 <- as.data.frame(effect(term="c.(familiarity):c.(maoriList)", mod=mExp2MaoriList))
# exp2ML_1$maoriList1 <- "Basic knowledge = 0"
# exp2ML_1[exp2ML_1$maoriList=="0",]$maoriList1 <- "Basic knowledge = 0"
...
# exp2ML_1[exp2ML_1$maoriList=="9",]$maoriList1 <- "Basic knowledge = 9"
# exp2ML_1$type <- "Word"
F_Exp2ML_1 <- ggplot(exp2ML_1, aes(x=familiarity, y=fit, color = type, fill=type)) + geom_line(size=1) + facet_grid(. ~ maoriList1) + geom_ribbon(aes(ymin=fit-se, ymax=fit+se),alpha=0.2, color=NA) + labs(x= "Familiarity", y="Accuracy") + scale_color_manual(values = c("Word" = "blue")) + scale_fill_manual(values = c("Word" = "blue")) + theme_bw() + theme(legend.position="none", panel.background = element_blank(), axis.text=element_text(size=10), axis.title=element_text(size = 12, face = "bold"),legend.text=element_text(size=10), strip.text = element_text(size = 12, face="bold")) 
...
# exp2ML_2[exp2ML_2$macron=="TRUE",]$Macron <- "Macron = TRUE"
# exp2ML_2$type <- "Word"
F_Exp2ML_2 <- ggplot(exp2ML_2, aes(x=macron, y=fit, color=type, fill=type)) + geom_point(size=4, position=position_dodge(width=0.2)) + geom_line(aes(x=as.integer(macron)), size=1, alpha=0.4, position=position_dodge(width=0.2)) + geom_errorbar(aes(ymin=fit-se, ymax=fit+se), size=1, width=0.3, position=position_dodge(width=0.2)) + xlab("Presence of macron") + ylab("Accuracy") + ylim(c(0, 1)) + scale_color_manual(values = c("Word" = "blue")) + scale_fill_manual(values = c("Word" = "blue")) + theme_bw() + theme(plot.title = element_text(hjust = 0.5, size=15), legend.position="none", panel.background = element_blank(), axis.text=element_text(size=13), axis.title=element_text(size = 13, face = "bold"),legend.text=element_text(size=12), strip.text = element_text(size = 13, face="bold")) 
